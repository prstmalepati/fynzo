...
export const SUPPORTED_COUNTRIES: CountryConfig[] = [
  ...
  // North America
  { code: 'US', name: 'United States', nameDE: 'Vereinigte Staaten', currency: 'USD', currencySymbol: '$', locale: 'en-US', taxCalculator: 'us', inflationRate: 3.2, flag: '🇺🇸', region: 'north-america' },
  { code: 'CA', name: 'Canada', nameDE: 'Kanada', currency: 'CAD', currencySymbol: 'C$', locale: 'en-CA', taxCalculator: 'canada', inflationRate: 2.7, flag: '🇨🇦', region: 'north-america' },
...
export type SupportedCurrency = 'EUR' | 'USD' | 'GBP' | 'CHF' | 'CAD' | 'INR';
...
export const SUPPORTED_CURRENCIES: { code: SupportedCurrency; symbol: string; name: string; nameDE: string }[] = [
  ...
  { code: 'CAD', symbol: 'C$', name: 'Canadian Dollar', nameDE: 'Kanadischer Dollar' },
