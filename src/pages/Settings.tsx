    ...
    <SidebarLayout>
      <div className="p-8 max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-8 border-2 border-slate-200 mb-6">
          <h2 className="text-2xl font-bold text-secondary mb-6">Account</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
              <div>
                ...
                <div className="font-semibold text-secondary">Free</div>
              </div>
        ...
        <div className="bg-white rounded-2xl p-8 border-2 border-slate-200 mb-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-secondary">Currency</h2>
        ...
        {/* Danger Zone */}
        <div className="bg-white rounded-2xl p-8 border-2 border-red-200 bg-red-50">
          <h2 className="text-2xl font-bold text-red-900 mb-4">Danger Zone</h2>
          
          <div className="space-y-4">
            <button
              onClick={handleSignOut}
              className="w-full px-6 py-4 bg-white border-2 border-red-300 text-red-700 rounded-xl hover:bg-red-50 transition-all font-bold text-left flex items-center justify-between group"
            >
              <div>
                <div className="font-bold text-red-900">Sign Out</div>
                <div className="text-sm text-red-600">You'll need to log in again</div>
              </div>
            ...
            <div className="p-4 bg-white rounded-xl border border-red-200">
              <div className="flex items-center justify-between">
                ...
                <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all font-semibold text-sm">
                  Delete
                </button>
              </div>
            </div>
