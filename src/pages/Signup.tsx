    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-hero relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-lg text-white/60 max-w-md mx-auto leading-relaxed">
            Join thousands building their financial future with clarity and confidence.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-white">
        <div className="w-full max-w-md animate-fadeIn">
          ...
          <p className="text-slate-500 mb-8">Start your wealth management journey</p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required
                className="w-full px-4 py-3 rounded-xl border border-slate-200 text-secondary placeholder-slate-400" placeholder="Min. 6 characters" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5">Confirm Password</label>
              <input type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required
                className="w-full px-4 py-3 rounded-xl border border-slate-200 text-secondary placeholder-slate-400" placeholder="••••••••" />
            </div>
