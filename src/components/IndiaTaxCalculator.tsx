...
// India FY 2025-26 (AY 2026-27) — New Tax Regime (default from FY 2023-24)
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-card p-6 lg:p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs bg-orange-100 text-orange-700 px-2 py-0.5 rounded-full font-semibold">FY 2025-26</span>
        </div>
          ...
          {!isNew && (
            <>
              <div>
                ...
                <input type="number" value={section80c} onChange={e => setSection80c(Number(e.target.value))}
              ...
              <div>
                ...
                <input type="number" value={section80d} onChange={e => setSection80d(Number(e.target.value))}
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl text-secondary" />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1.5">NPS 80CCD(1B) (max ₹50K)</label>
                <input type="number" value={nps} onChange={e => setNps(Number(e.target.value))}
              ...
              <div>
                ...
                <input type="number" value={homeLoan} onChange={e => setHomeLoan(Number(e.target.value))}
