      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-purple-600 via-purple-700 to-pink-600 p-8 text-white z-10 rounded-t-3xl">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-4xl font-bold font-crimson mb-2">Create New Scenario</h2>
        ...
        <div className="p-8 space-y-8">
                  ...
                  {emojiOptions.map((e) => (
                    <button
                      ...
                      className={`w-12 h-12 text-2xl rounded-xl border-2 transition-all ${
                        emoji === e ? 'border-purple-600 bg-purple-50' : 'border-slate-300 hover:border-purple-400'
                      }`}
                    >
                      {e}
                    </button>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-slate-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                />
                <p className="text-sm text-slate-600 mt-1">Savings Rate: {(savingsRate * 100).toFixed(0)}%</p>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border-2 border-slate-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Amount ({currency})</label>
                    <input
                      type="number"
                      value={eventAmount}
                  ...
                  <div className="flex items-center">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-sm font-semibold text-slate-700">Recurring annually</span>
                    </label>
                  </div>
                </div>
            ...
            {lifeEvents.length > 0 ? (
              <div className="space-y-2">
                {lifeEvents.map((event, index) => (
                  <div key={index} className="flex items-center justify-between bg-white rounded-xl p-4 border border-slate-200">
              ...
              <p className="text-slate-500 text-center py-6">No life events added yet</p>
            )}
          </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button
              onClick={onClose}
              className="px-8 py-4 bg-white border-2 border-slate-300 text-slate-700 rounded-2xl font-bold text-lg hover:bg-slate-50 transition-all"
            >
              Cancel
            </button>
          </div>
